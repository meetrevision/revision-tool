...
void main() {
  ...
  group(
    ...
    skip: skipIntegration
        ...
        : false,
    () {
      late UpdatesService service;

      setUp(() {
        service = const UpdatesServiceImpl();
      });
      ...
      group('Service Instance', () {
        test('UpdatesService can be instantiated', () {
          expect(() => const UpdatesServiceImpl(), returnsNormally);
        });

        test('UpdatesService is const constructible', () {
  ...
  group('UpdatesService - Mocked (CI Safe)', () {
    late MockUpdatesService mockService;

    setUp(() {
      mockService = MockUpdatesService();
    });
