...
void main() {
  ...
  group(
    ...
    skip: skipIntegration
        ...
        : false,
    () {
      late UtilitiesService service;

      setUp(() {
        service = const UtilitiesServiceImpl();
      });
      ...
      group('Service Instance', () {
        test('UtilitiesService can be instantiated', () {
          expect(() => const UtilitiesServiceImpl(), returnsNormally);
        });

        test('UtilitiesService is const constructible', () {
  ...
  group('UtilitiesService - Mocked (CI Safe)', () {
    late MockUtilitiesService mockService;

    setUp(() {
      mockService = MockUtilitiesService();
    });
