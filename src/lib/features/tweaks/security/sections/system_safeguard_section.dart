...
class SystemSafeguardsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CardHighlight(
      ...
      label: context.l10n.tweaksSecuritySystemSafeguards,
      description: context.l10n.tweaksSecuritySystemSafeguardsDescription,
...
class _UACCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CardListTile(
      ...
      title: context.l10n.tweaksSecurityUAC,
      description: context.l10n.tweaksSecurityUACDescription,
